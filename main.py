...
if __name__ == "__main__":
    ...
    #
    # python3 main.py --num_img 10 --strict --num_processes 2 --config_file ./configs/default.yaml --bg_dir ./data/autoworkbg --output_dir ~/文档/text_renderer --tag output
    #
    # python3 main.py --num_img 100 --strict --num_processes 2 --chars_file ./data/chars/num.txt --fonts_list ./data/fonts_list/invoice_num.txt --corpus_dir ./data/corpus_base_img --config_file ./configs/autowork.yaml --fonts_by_image True --bg_dir ./data/bg_invoice --output_dir ~/文档/text_renderer --tag output
    #
    # python3 main.py --num_img 1000000 --strict --num_processes 8 --chars_file ./data/chars/num.txt --fonts_list ./data/fonts_list/invoice_num.txt --corpus_dir ./data/corpus_base_img --config_file ./configs/autowork.yaml --fonts_by_image True --bg_dir ./data/bg_invoice --output_dir /home/jovyan/data-modified/ocr_render/output --tag fonts_by_images
    #
